...
py_test_dir := test_dir / "spanning-supernets-py/"
py_test_justfile := py_test_dir / "justfile"
...
[private]
test_py:
	just --justfile {{py_test_justfile}} --working-directory {{py_test_dir}} test
...
[private]
fmt_py:
    just --justfile {{py_test_justfile}} --working-directory {{py_test_dir}} fmt
